<?php
/*
Plugin Name: TF Woo Product Mini Cart Addon For Elementor
...
final class TFWoo_Pro_Mini_Addon_Elementor {
    ...
    public function widget_styles() {
        ...
        wp_register_style( 'tf-woo-product-minicart', plugins_url( '/assets/css/tf-style.css', __FILE__ ) );        
    }
    ...
    public function widget_scripts() {
        ...
        wp_register_script( 'tf-woo-product-minicart', plugins_url( '/assets/js/tf-main.js', __FILE__ ), [ 'jquery' ], false, true );
    }
...
TFWoo_Pro_Mini_Addon_Elementor::instance();