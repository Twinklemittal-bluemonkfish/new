 ...
 */
if ($size_guide) {
    $content .= '<li class="nasa-popup-node-item nasa-size-guide">';
    
    /**
     * Dom click
     */
    $content .= '<a class="nasa-node-popup" href="javascript:void(0);" data-target="#nasa-content-size-guide" title="' . esc_attr__('Size Guide', 'nasa-core') . '" rel="nofollow">' . esc_html__('Size Guide', 'nasa-core') . '</a>';
...
if ($delivery_return) {
     ...
     * Dom click
     */
    $content .= '<a class="nasa-node-popup" href="javascript:void(0);" data-target="#nasa-content-delivery-return" title="' . esc_attr__('Delivery &#38; Return', 'nasa-core') . '" rel="nofollow">' . esc_html__('Delivery &#38; Return', 'nasa-core') . '</a>';
...
if ($ask_a_question) {
     ...
     * Dom click
     */
    $content .= '<a class="nasa-node-popup" href="javascript:void(0);" data-target="#nasa-content-ask-a-quetion" title="' . esc_attr__('Ask a Question', 'nasa-core') . '" rel="nofollow">' . esc_html__('Ask a Question', 'nasa-core') . '</a>';
...
if ($request_a_callback) {
     ...
     * Dom click
     */
    // $content .= '<a class="nasa-node-popup" href="javascript:void(0);" data-target="#nasa-content-request-a-callback" title="' . esc_attr__('Request a Call Back', 'nasa-core') . '" rel="nofollow">' . esc_html__('Request a Call Back', 'nasa-core') . '</a>';
