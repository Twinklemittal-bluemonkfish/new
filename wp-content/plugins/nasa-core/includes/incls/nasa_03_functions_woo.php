 ...
 */
function nasa_get_product_meta_value($post_id = 0, $field = null) {
    ...
    if (isset($meta_value[0]) && $field) {
        return isset($meta_value[0][$field]) ? $meta_value[0][$field] : '';
    }
 ...
 */
add_action('woocommerce_checkout_after_customer_details', 'nasa_checkout_after_customer_details');
